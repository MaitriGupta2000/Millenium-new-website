...
export function HeroSection() {
  ...
  const initialHeight = 800; // Default height, adjusted on client side
  ...
  return (
    <section className="relative bg-black -mt-20 overflow-hidden">
      ...
      >
        ...
        >
          <div
            className={`absolute inset-0 w-full h-full object-cover transition-all duration-1000 bg-gradient-to-br from-amber-100 to-amber-200 ${
