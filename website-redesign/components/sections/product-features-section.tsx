      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-20 text-center">
          <div className="inline-flex items-center gap-3 mb-6">
            ...
            <span className="text-sm font-medium text-amber-600 uppercase tracking-wider">Quality Promise</span>
            <div className="h-1 w-8 bg-amber-500 rounded-full"></div>
          </div>
          <h2 
        ...
        <div className="space-y-32">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div 
                className={`aspect-[3/2] relative overflow-hidden bg-[#F5F5F5] rounded-3xl ${index % 2 === 1 ? 'md:order-1' : ''}`}
              >
                <img 
